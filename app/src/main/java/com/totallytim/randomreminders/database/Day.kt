...
fun isValidTime(day: Day, hours: Int, minutes: Int): Boolean {
    if (hours >= 24 || minutes >= 60) {
        throw IllegalArgumentException()
    }
    // 6 slots of 4H sections (0H, 4H ...)
    val hourIndex = floor(hours / 6.0).toInt()
    val nthDigit = nthDigit(day.availability, hourIndex, HEX_BASE)
 ...
 */
fun isValidDay(day: Day) = (day.availability != 0x000000)